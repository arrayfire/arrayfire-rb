...
void Init_arrayfire() {
  ...
  rb_define_method(Af_Array, "set_manual_eval_flag", (METHOD)arf_set_manual_eval_flag, 0);
  rb_define_method(Af_Array, "get_manual_eval_flag", (METHOD)arf_get_manual_eval_flag, 0);
